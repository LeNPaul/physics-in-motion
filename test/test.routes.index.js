...
describe('index routes', () => {
  ...
  it('return the home page', (done) => {
    chai.request('http://localhost:8080').get('/').end((err, res) => {
...
describe('about routes', () => {
  ...
  it('return the about page', (done) => {
    chai.request('http://localhost:8080').get('/about').end((err, res) => {
      res.status.should.be.equal(200);
...
describe('contact routes', () => {
  ...
  it('return the contact page', (done) => {
    chai.request('http://localhost:8080').get('/contact').end((err, res) => {
      res.status.should.be.equal(200);
...
describe('privacy routes', () => {
  ...
  it('return the privacy page', (done) => {
    chai.request('http://localhost:8080').get('/privacy').end((err, res) => {
      res.status.should.be.equal(200);
...
describe('terms routes', () => {
  ...
  it('return the terms page', (done) => {
    chai.request('http://localhost:8080').get('/terms').end((err, res) => {
      res.status.should.be.equal(200);
